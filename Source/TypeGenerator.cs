...
internal sealed class TypeGenerator
{
    ...
    private List<string> CollectBaseTypes(Type clrType, out bool isPrimaryBaseUserdata)
    {
        ...
        var baseTypes = new List<string>(8 + interfaces.Length);
    ...
    private void GenerateFields(Type clrType, LuaClass luaClass, bool findAllMembers = false)
    {
        ...
        {
            if (TypeHelper.IsCompilerGenerated(property) || visitedNames.Contains(property.Name)) continue;
        ...
        {
            if (TypeHelper.IsCompilerGenerated(field) || visitedNames.Contains(field.Name)) continue;
