...
通过加载 C# 程序集，将其中的类型转换为遵循 [xLua](https://github.com/Tencent/xLua) 和 [LuaLS](https://github.com/LuaLS/lua-language-server) 标准的 [EmmyLua](https://emmylua.github.io/index.html) 文档。
