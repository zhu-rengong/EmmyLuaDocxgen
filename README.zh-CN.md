...
通过加载 C# 程序集，将其中的类型转换为遵循 [MoonSharp](https://github.com/moonsharp-devs/moonsharp/) 和 [LuaLS](https://github.com/LuaLS/lua-language-server) 标准的 [EmmyLua](https://emmylua.github.io/index.html) 文档。
...
- 包括成员
  ...
  - `property`: 属性
  - `indexer`: 索引器
  - `method`: 方法，支持重载、异步、由 **xLua** (仅供参考，因为该分支遵循 MoonSharp by evil-factory 的标准) 自动解释的泛型、可选参数、可变参数
...
### 3. 生成示例
- [潜渊症Lua注解](https://github.com/zhu-rengong/Barotrauma-Lua-Annotations)
